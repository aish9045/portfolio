          ...
          >
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                ...
                <span className="qualification__subtitle">Gl Bajaj Institue of Technology and Management, Greater Noida</span>
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              ...
              <div>
                <h3 className="qualification__title">St. Thomas Sr. Sec. School, Mainpuri,U.P.</h3>
                <span className="qualification__subtitle">ISC, Mainpuri</span>
                <div className="qualification__calender">
